...
class Platform:
    image = pygame.image.load("platforma 2 (1).png")
    counter = 0
    ...
    def __init__(self, x, y):
        self.x = x
        self.y = y
        self.image = pygame.transform.scale( pygame.image.load("platforma 2 (1).png"), (200, 50))
...
hero = pygame.image.load('hagi lagi (1).png')
...
while run:
    ...
    if playerY + offsetY < 100:
        offsetY += abs(playerY + offsetY - 100)/50
